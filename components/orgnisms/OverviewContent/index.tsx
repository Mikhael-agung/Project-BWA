              ...
              <tbody>
                ...
                <tr className="align-middle text-center">
                  <th scope="row">
                    ...
                    <div className="game-title-header">
                      <p className="game-title fw-medium text-start color-palette-1 m-0">Valorant</p>
                      <p className="text-xs fw-normal text-start color-palette-2 m-0">Dekstop</p>
                    </div>
                  </th>
                  <td>
                    <p className="fw-medium text-start color-palette-1 m-0">225 VP</p>
                  </td>
                  <td>
