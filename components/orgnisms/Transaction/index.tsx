...
import StepItem from '../../molcecules/StepItems'
  ...
  return (
    <section id="feature" className="feature
                                                ...
                                                <div className="container-fluid">
                                                    <h2 className="text-4xl fw-bold
                                                        color-palette-1
                                                        text-center mb-30">It’s
                                                        Really That<br/> Easy to
                                                        Win the Game
                                                    </h2>
                                                    <div className="row gap-lg-0
                                                        gap-4"
                                                        data-aos="fade-up">
                                                        <StepItem icon={'step1'} title={'1. start'}  desc1={'Pilih salah satu game'} desc2='yang
                                                                                                        ingin
                                                                                                        kamu
                                                                                                        top
                                                                                                        up' />
