...
export default function Auth(props: Partial<AuthProps>) {
            ...
            <li className="nav-item my-auto dropdown d-flex">
                                                ...
                                                <a className="dropdown-toggle ms-lg-40" href="#" role="button" id="dropdownMenuLink"
                                                    ...
                                                    <ul className="dropdown-menu border-0" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <li><Link href='/Wallet' className="dropdown-item text-lg color-palette-2">Wallet</Link></li>
  ...
  return (
                                            <li className="nav-item my-auto">
                                                <Link href='/sign-in' className="btn btn-sign-in d-flex
                                                    justify-content-center
                                                    ms-lg-2 rounded-pill"
                                                    role="button"> Sign
                                                    In 
                                                </Link>
